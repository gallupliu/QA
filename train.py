...
word2vec_model = KeyedVectors.load_word2vec_format(r'E:\nlp\sougou-qa\sougou-factorid\data\wiki_binary50.model', binary=True)
#word2vec_model = Word2Vec.load(r'E:\nlp\sougou-qa\sougou-factorid\data\wiki_binary50.model')
