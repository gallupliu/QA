...
tf.flags.DEFINE_float("lr", 1.1, "the proportion of dropout")
...
tf.flags.DEFINE_integer("num_unroll_steps", 101, "embedding size")
tf.flags.DEFINE_integer("max_grad_norm", 5, "embedding size")
tf.flags.DEFINE_integer("attention_matrix_size", 100, "embedding size")
# Misc Parameters
